...
import com.lcc.bean.entity.RcDataDictionaryListExample;
import com.lcc.dao.DataDictionaryListDao;
import com.lcc.mybatis.RcDataDictionaryListMapper;
...
public class DataDictionaryListDaoImpl implements DataDictionaryListDao {
    ...
    public int deleteByFieldCode(String fieldCode) {
        ...
        RcDataDictionaryListExample.Criteria criteria = example.createCriteria();
